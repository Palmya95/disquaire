...
SECRET_KEY = 'cb0x^@kt!vu(e(c+bq1_t8s=fegn2_(=)#t$3-$i(b&*jj2=)8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['35.239.191.74']
...
DATABASES = {
    'default': {
        ...
        'USER': 'mmastor_cloud', # attention : remplacez par votre nom dutilisateur
        'PASSWORD': '',
        'HOST': '',
        'PORT': '5432',
    }
